...
public class Ellipse implements Shape {
	...
	public boolean contains(int x, int y) {
		...
		return Math.pow(dx / a, 2) + Math.pow(dy / b, 2) <= 0.9;
	}
	...
	public static Ellipse fromString(String information){
		String[] info = information.split("\\s");
		return new Ellipse(Integer.parseInt(info[1]), Integer.parseInt(info[2]), Integer.parseInt(info[3]), Integer.parseInt(info[4]), new Color(Integer.parseInt(info[5])));
