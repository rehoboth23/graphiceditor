...
public class Segment implements Shape {
	...
	public static Segment fromString(String information){
		String[] info = information.split("\\s");
		return new Segment(Integer.parseInt(info[1]), Integer.parseInt(info[2]), Integer.parseInt(info[3]), Integer.parseInt(info[4]), new Color(Integer.parseInt(info[5])));
